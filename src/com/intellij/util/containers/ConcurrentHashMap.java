...
public final class ConcurrentHashMap<K, V> extends AbstractMap<K, V>
  ...
  private static class Node<K, V> implements Map.Entry<K, V> {
    ...
    @NotNull final HashingStrategy<K> myHashingStrategy;
  ...
  @NotNull private final HashingStrategy<K> myHashingStrategy;
  ...
  public ConcurrentHashMap(int initialCapacity, float loadFactor, int concurrencyLevel, @NotNull HashingStrategy<K> hashingStrategy) {
  ...
  public ConcurrentHashMap(@NotNull HashingStrategy<K> hashingStrategy) {
  ...
  private static final class ForwardingNode<K, V> extends Node<K, V> {
    ...
    private ForwardingNode(Node<K, V>[] tab, @NotNull HashingStrategy<K> hashingStrategy) {
  ...
  private static final class TreeNode<K, V> extends Node<K, V> {
    ...
    TreeNode(int hash, K key, V val, Node<K, V> next,
             TreeNode<K, V> parent, HashingStrategy<K> hashingStrategy) {
  ...
  private static final class TreeBin<K, V> extends Node<K, V> {
     ...
     */
    private TreeBin(TreeNode<K, V> b, HashingStrategy<K> hashingStrategy) {
