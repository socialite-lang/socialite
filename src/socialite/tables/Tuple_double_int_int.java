...
public class Tuple_double_int_int extends Tuple implements Externalizable {
	...
	public Tuple_double_int_int() {}

	public Tuple_double_int_int(double __0, int __1, int __2) {
		_0 = __0;
		_1 = __1;
		_2 = __2;
	...
	public Tuple_double_int_int clone() {
		return new Tuple_double_int_int(_0, _1, _2);
	}

	public int size() { return 3; }

	public void update(Tuple _t) {
		if (!(_t instanceof Tuple_double_int_int))
			throw new SociaLiteException("Not supported operation");

		Tuple_double_int_int t = (Tuple_double_int_int)_t;
		_0 = t._0;
		_1 = t._1;
		_2 = t._2;
	...
	public boolean equals(Object o) {
		...
		Tuple _t = (Tuple)o;
		if (_t.getClass().equals(Tuple_double_int_int.class)) {
			Tuple_double_int_int t=(Tuple_double_int_int)_t;
