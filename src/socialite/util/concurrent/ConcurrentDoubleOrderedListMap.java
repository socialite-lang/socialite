...
/**
 * A memory-efficient concurrent map with primitive double keys.
 ...
 *  public boolean replace(double key, V old, V value)
 *  public V put(double key, V value)
 *  public V putAtomic(double key, V value)
 *  public V putAtomicIfAbsent(double key, V value)
 *  public DoubleObjectIterator<V> iterator()
 *  public DoubleObjectIterator<V> iteratorFrom(double low, boolean lowInclusive)
 *  public DoubleObjectIterator<V> iteratorTo(double high, boolean highInclusive)
 *  public DoubleObjectIterator<V> iterator(double low, double high, boolean lowInclusive, boolean highInclusive)
 *  public class DoubleObjectIterator<V> {
 ...
 */
public class ConcurrentDoubleOrderedListMap<V> {
    /*
     ...
     */
    static ConcurrentDoubleSkipListMap.CallbackOnFound<Node> refCntCallback =
                    new ConcurrentDoubleSkipListMap.CallbackOnFound<Node>() {
    ...
    final Node head;
    ConcurrentDoubleSkipListMap<Node> skipListMap;

    public ConcurrentDoubleOrderedListMap() {
        skipListMap = new ConcurrentDoubleSkipListMap<Node>();
        head = new HeadNode(0);
    }
    ...
    public boolean remove(double key, V old) {
        if (old == null)
    ...
    static class Node {
        ...
        static private void nodeCopy(double[] srcKeys, Object[] srcVals, int srcBegin,
                                     double[] targetKeys, Object[] targetVals, int targetBegin, int copyLen) {
        ...
        int findKeyIndex(double key) { return Arrays.binarySearch(keys, 0, len(), key); }
        ...
        // no concurrent read/write access is assumed
        private void putReally(int pos, double key, Object value, ConcurrentDoubleOrderedListMap orderedMap) {
            int len = len();
        ...
        // concurrent read/write access is allowed
        Object putAtomic(double key, Object value, Node b, boolean onlyIfAbsent, ConcurrentDoubleOrderedListMap orderedMap) {
            synchronized(b) {
        ...
        private void putAtomicReally(Node b, int pos, double key, Object value, ConcurrentDoubleOrderedListMap orderedMap) {
            int len = len();
    ...
    public static class DoubleObjectIterator<V> {
        Node current;
        int len;
        int pos;
        double low, high;
        ...
        double key;
        V val;
        DoubleObjectIterator(ConcurrentDoubleOrderedListMap map, double lo, double hi, boolean loIncl, boolean hiIncl) {
            low = lo;
            high = hi;
            orderedMap = map;
            lowInclusive = loIncl;
    ...
    public DoubleObjectIterator<V> iterator() {
        return iterator(Double.MIN_VALUE, Double.MAX_VALUE, true, true);
    }
    public DoubleObjectIterator<V> iteratorFrom(double low, boolean lowInclusive) {
        return iterator(low, Double.MAX_VALUE, lowInclusive, true);
    }
    public DoubleObjectIterator<V> iteratorTo(double high, boolean highInclusive) {
        return iterator(Double.MIN_VALUE, high, true, highInclusive);
    }
    public DoubleObjectIterator<V> iterator(double low, double high, boolean lowInclusive, boolean highInclusive) {
        return new DoubleObjectIterator<V>(this, low, high, lowInclusive, highInclusive);
    }
    ...
    static void iterateFromTest() {
        final ConcurrentDoubleOrderedListMap<String> map1 = new ConcurrentDoubleOrderedListMap<String>();
        map1.put(25, "25");
        map1.put(30, "30");
        map1.put(31, "31");
